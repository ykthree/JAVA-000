...
-- -----------------------------------------------------
-- 外汇交易库
DROP SCHEMA IF EXISTS `cny_account` ;
...
-- 外汇交易库
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `cny_account` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `cny_account` ;

-- -----------------------------------------------------
-- Table `dollar_account`.`dollar_account`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cny_account`.`cny_account` ;
